...
export const ComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return (
        <div style={{ width: '100%', minHeight: '600px', padding: '10px' }} ref={ref}>
            ...
            <div style={{ width: '100%', margin: '20px 0' }} className="w-full mt-5">
                <table style={{ width: '100%' }} className="mytable2 w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colSpan={7} style={{ textTransform: 'capitalize', fontStyle: 'italic' }} className="italic">Bằng chữ: <span className="text-[13px] capitalize">{to_vietnamese(props.data.totalCost)} đồng</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
